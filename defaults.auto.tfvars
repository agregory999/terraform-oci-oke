...
################################
# Leave anything below here for auto.tfvars (defaults)
################################
...
# Xweek
compartment_id = "ocid1.compartment.oc1..aaaaaaaafbm553q5u5b6wwtcfd7kyukz773exiq4or2gspqjrnoti5zrfjyq"
label_prefix   = "dev"
...
subnets = {
  ...
  cp       = { netnum = 1, newbits = 9 }
  int_lb   = { netnum = 2, newbits = 9 }
  pub_lb   = { netnum = 3, newbits = 9 }
...
bastion_timezone = "America/New_York"
bastion_type     = "public"
